...
//            + presenter.descriptionCategoryData.count
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        case 3:
            ...
            let categoryDescription = presenter.descriptionCategoryData[indexPath.row]
            
            let cellDS =  collectionView.dequeueReusableCell(withReuseIdentifier: "BigVCViewCell", for: indexPath)as? BigVCViewCell
            cellDS?.configureDS(with: categoryDescription)
            return cellDS ?? UICollectionViewCell()
