...
struct SceneFactory {
    ...
    static func makeMainFlow(coordinator: AppCoordinator, finishDelegate: CoordinatorFinishDelegate) -> TabBarController {
        ...
        let orderCootdinator = HomeCoordinator(type: .home, navigationController: orderNavigatationcontroller)
        ...
        let listCootdinator = HomeCoordinator(type: .home, navigationController: listNavigatationcontroller)
        ...
        let profileCootdinator = HomeCoordinator(type: .home, navigationController: profileNavigatationcontroller)
